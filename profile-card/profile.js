export default class ProfileCard extends HTMLElement {
  ...
  constructor() {
    super();
    console.log("contrutor ProfileCard");
  ...
  connectedCallback() {
    ...
    this.infoEl = this.shadowRoot.querySelector(".profile-info"); //procura pela class

    this.btnEl.addEventListener("click", () => {
      this.collapsed = !this.collapsed;
      if (this.collapsed) {
        this.infoEl.style.display = "none";
        this.btnEl.innerHTML = "show details";
      } else {
        this.infoEl.style.display = "block";
        this.btnEl.innerHTML = "hide details";
      }
      console.log("clicou");
    });
  }
